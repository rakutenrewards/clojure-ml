...
(deftest infer-regression-test
  (testing "Verifies the value outputted by a regression ETA model. https://github.com/RakutenReady/Team/issues/54141"
    (let [model (models/load :xgboost (.getPath (io/as-file (io/resource "models/eta/regression-test/5659.xgb"))))
          ...
          feature-map {:average-approaching-speed-4 0.0,
                       ...
                       :lng -71.204523}
          prediction (models/infer :xgboost :regression model
      ...
      (is (= 777.2630419759837 prediction)))))
