...
| =weight-feature-name=    | Feature to use to set sample weights. Must also set label-name and stddev | =string=   | Any                                           |                       null |
| =weight-label-name=      | Label to compare to weight-feature-name to set sample weights.            | =string=   | Any                                           |                       null |
