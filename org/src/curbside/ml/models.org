...
#+BEGIN_SRC clojure
(s/def ::hyperparameter-search-fn-type #{:grid :random})
...
(s/def ::random-search-data-type #{:integer :decimal :string})

(s/def ::random-search-data-common
  (s/keys :req-un [::random-search-data-type]))

(s/def ::random-search-data-integer-min int?)

(s/def ::random-search-data-integer-max int?)

(s/def ::random-search-data-decimal-max decimal?)

(s/def ::random-search-data-decimal-min decimal?)

(s/def ::random-search-data-string-values (s/coll-of string?))

(s/def ::random-search-data-integer (s/keys :req-un [::random-search-data-integer-min
                                                     ::random-search-data-integer-max]))
(s/def ::random-search-data-decimal (s/keys :req-un [::random-search-data-decimal-min
                                                     ::random-search-data-decimal-max]))
(s/def ::random-search-data-string (s/keys :req-un [::random-search-data-string-values]))
...
(s/def ::random-search-data-spec (s/multi-spec random-search-data :type))
...
(defn- random-value
  ...
  [constraints]
  (let [type (:data-type constraints)
        min (:min constraints)
        max (:max constraints)
...
(defn optimize-hyperparameters
  ...
  [algorithm predictor-type selected-features hyperparameters hyperparameter-search-space training-set-path
   & {:keys [hyperparameter-search-fn selection-metric k-folds threads-pool scaling-factors feature-scaling-fns label-scaling-fns]}]
  {:pre [(spec/check ::algorithm algorithm)
         ...
         (case (:type hyperparameter-search-space)
           :random (map (fn [[k v]] (random-search-data-spec v)) hyperparameter-search-space)
           )
         ]}
